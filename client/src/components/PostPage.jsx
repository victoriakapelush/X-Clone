...
useEffect(() => {
                ...
                <div className='flex-column popup-reply-post'>
                    <div className='flex-row horizontal-line-replies-section comment-hover'>
                        ...
                        <div className='reply-summary-post flex-column'>
                            ...
                            {post && post.text && <span className='reply-post-text'>{post.text}</span>}
                            {post && post.image && <img className='reply-post-text reply-post-image' src={`http://localhost:3000/uploads/${post.image}`} />}
                            {post && post.gif && <img className='reply-post-text reply-post-gif' src={post.gif} />}
    ...
    post.totalReplies.map((reply) => (
        <div key={reply._id} className="flex-column comment-hover">
            <Link to={`/post/${reply.user.formattedUsername}/status/${reply._id}`}>
