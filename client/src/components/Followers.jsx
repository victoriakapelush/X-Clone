        ...
        <header className="flex-row">
          ...
          <div className="flex-column profile-header-name">
            {userData && userData.profile && (
              <h2>{userData.profile.updatedName}</h2>
            )}
            {userData && userData.profile && (
              <span>@{userData.formattedUsername}</span>
            )}
          </div>
        </header>
        <div className="flex-row mini-header-btns-container">
          <div
            className={`mini-header-btn ${activeTab === "followers" ? "active" : ""}`}
          >
            ...
            <div className="home-profile-posts followers-container">
              {following.length === 0 ? (
                <div className="no-followers-message flex-column">
                  ...
                  <p>
                    Following accounts is an easy way to curate your timeline
                    and know what’s happening with the topics and people you’re
                    interested in.
                  </p>
                </div>
              ) : (
