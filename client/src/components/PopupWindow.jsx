    ...
    <div className="popup-container flex-row">
      <div className="black-window flex-column">
        <div className="svg-text-wrap-top flex-column">
          <svg
            className="popup-image flex-row"
            viewBox="0 0 15 15"
            aria-label="X"
            role="img"
          >
          ...
          <div className="popup-text flex-column">
            ...
            <span className="selfie-popup-text">
              Have a favorite selfie? Upload it now.
            </span>
          </div>
        </div>
        <div
          className="photo-upload-frame flex-row"
          style={{
        ...
        {!selectedImage ? (
          <Link to="/home">
            <button className="skip-for-now-btn" onClick={onClose}>
              Skip for now
            </button>
          </Link>
        ) : (
