    ...
    return(
        <div className='flex-row profile-page'>
            ...
            <div className='profile-container'>
                ...
                {singleUser && <span className='profile-user-name'>{singleUser.originalUsername}</span>}
                {singleUser && <span className='user-tag'>@v{singleUser.formattedUsername}</span>}
                    {singleUser && singleUser.profile && <p className='user-profile-description'>{singleUser.profile.profileBio}</p>}
                    <div className='flex-row location-date-container'>
                        <div className='flex-row location-container'>
                            ...
                            {singleUser && singleUser.profile && <span>{singleUser.profile.location}</span>}
                        </div>
                        <div className='flex-row location-container'>
                            ...
                            {singleUser && singleUser.profile && <span>{singleUser.profile.registrationDate}</span>}
                        </div>
                    </div>
                    {singleUser && singleUser.profile && <div className='flex-row following-container'>
                        <span className='following-number'>{singleUser.profile.following} <span className='following-grey'>Following</span></span>
                        <span className='following-number'>{singleUser.profile.followers} <span className='following-grey'>Followers</span></span>
                    </div>}
