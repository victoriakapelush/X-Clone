...
const trainingData = [
    ...
    { text: 'New study shows the benefits of a Mediterranean diet.', tags: ['health'] },
    { text: 'Check out my new recipe for a vegan lasagna.', tags: ['lifestyle'] },
    { text: 'NASA discovered a new exoplanet.', tags: ['science'] },
    { text: 'Why don’t scientists trust atoms? Because they make up everything!', tags: ['humor'] },
    { text: 'Breaking news: Earthquake in California.', tags: ['current events'] },
    { text: 'A man walks into a library and asks the librarian for a book on Pavlov\'s dogs and Schrodinger\'s cat. The librarian responds, "It rings a bell, but I\'m not sure if it\'s here or not."', tags: ['humor'] },
    ...
    { text: 'Ever wondered why cows have hooves instead of feet? Because they lactose! If you need a good laugh, check out our collection of the funniest animal jokes.', tags: ['humor'] },
    { text: 'Just heard a great joke: Why did the math book look sad? Because it had too many problems. If you need a mood boost, make sure to follow our account for daily doses of humor and light-hearted fun.', tags: ['humor'] },
    { text: 'Why don’t skeletons fight each other? They don’t have the guts. If you’re a fan of puns and good laughs, follow us for your daily dose of humor and clever jokes!', tags: ['humor'] },
    { text: 'I told my wife she was drawing her eyebrows too high. She looked surprised. Stick around for more funny anecdotes and witty humor—guaranteed to make you smile!', tags: ['humor'] },
    { text: 'I used to play piano by ear, but now I use my hands. Follow us for daily jokes and funny stories that’ll brighten up your day and give you a good laugh!', tags: ['humor'] },
    { text: 'Why did the scarecrow win an award? Because he was outstanding in his field! For more hilarious jokes and funny content, make sure to keep up with our posts!', tags: ['humor'] },
    { text: 'Parallel lines have so much in common. It’s a shame they’ll never meet. Stay tuned for more clever humor and entertaining jokes to keep you laughing throughout the day!', tags: ['humor'] }
];
...
const loadClassifier = (callback) => {
    natural.BayesClassifier.load(path.join(__dirname, 'classifier.json'), null, (err, loadedClassifier) => {
        if (err) {
            if (err.code === 'ENOENT') {
